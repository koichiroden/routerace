...
`configs/` にあるレース設定を選んでボタンを押すだけで動画生成できる、
簡易的なWebページを同梱しています。
